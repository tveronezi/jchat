...
(function () {
    ...
    function setNameAndPost(txt) {
        Ext.Msg.prompt(jchat.i18n.get('name'), jchat.i18n.get('enter.name'), function (buttonText, rawName) {
            ...
            if (Ext.isEmpty(name)) {
                ...
                Ext.Ajax.request({
                    ...
                    success: function (response) {
                        ...
                        if (json.authenticationResultDto && json.authenticationResultDto.success) {
                            window.ux.authenticated = true;
                            postMessage(txt);
                        } else {
                            Ext.Msg.alert('login.exception', json.authenticationResultDto.info, function () {
                                setNameAndPost(txt);
                            });
                        }
                    },
    ...
    Ext.define('jchat.controller.Message', {
